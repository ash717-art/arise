        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text('Select your workout days', style: Theme.of(context).textTheme.displaySmall),
              const SizedBox(height: 30),
              Wrap(
                spacing: 8.0,
                runSpacing: 8.0,
                children: days.map((day) {
                  final isSelected = onboardingModel.workoutDays.contains(day);
                  return ChoiceChip(
                    label: Text(day),
                    selected: isSelected,
                    onSelected: (selected) {
                    ...
                    labelStyle: TextStyle(color: isSelected ? AppTheme.primaryCtaText : AppTheme.textPrimary),
                  );
                }).toList(),
              ),
              if (onboardingModel.workoutDays.length > onboardingModel.workoutsPerWeek)
                Padding(
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Text('Smart Reminders', style: Theme.of(context).textTheme.headlineSmall),
                        Switch(
                          value: onboardingModel.remindersEnabled,
                          onChanged: (value) => onboardingNotifier.setReminders(value),
              ...
              BottomCTAButton(
                text: 'Continue',
                enabled: onboardingModel.workoutDays.length <= onboardingModel.workoutsPerWeek && onboardingModel.workoutDays.isNotEmpty,
                onTap: () {
