...
import 'package:myapp/screens/onboarding/target_weight_screen.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              const TopProgressBar(currentStep: 7, totalSteps: 13),
              const SizedBox(height: 30),
              Text('What is your current weight?', style: Theme.of(context).textTheme.displaySmall),
              const SizedBox(height: 30),
              Row(
              ...
              Expanded(
                child: CupertinoPicker(
                  ...
                  scrollController: FixedExtentScrollController(
                    initialItem: (isKg ? onboardingModel.currentWeight : onboardingModel.currentWeight * 2.20462).toInt() - 30,
                  ),
                  onSelectedItemChanged: (int index) {
                    double selectedValue = (index + 30).toDouble();
                    if (isKg) {
                      onboardingNotifier.setCurrentWeight(selectedValue);
                    } else {
                      onboardingNotifier.setCurrentWeight(selectedValue / 2.20462);
                    }
                  },
              ...
              BottomCTAButton(
                text: 'Continue',
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (_) => const TargetWeightScreen()));
                },
              ),
